...
public class RandomPerson {
    public static List<String> LAST_NAMES = readNames("/dist.all.last");
    public static List<String> MALE_NAMES = readNames("/dist.male.first");
    public static List<String> FEMALE_NAMES = readNames("/dist.female.first");

    public static Iterator<Person> iteratorOf(final int count) {
    ...
    public static List<Person> listOf(final int count) {
    ...
    private static List<String> readNames(final String resourceName) {
        ...
        try (BufferedReader reader = new BufferedReader(
            ...
            final List<String> list = stream.map(s -> s.substring(0, 15).trim()).collect(Collectors.toList());
